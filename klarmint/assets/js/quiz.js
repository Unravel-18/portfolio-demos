/* Klarmint — quiz-brief «Wycena w 2 minuty» (vanilla, 0 deps) */
(function () {
  "use strict";
  ...
  function finish() {
    ...
    send.setAttribute("href", "mailto:" + MAIL + "?subject=" + encodeURIComponent("Brief z wyceny — Klarmint") + "&body=" + encodeURIComponent(brief));
    if (WEB3_KEY) {
  ...
  function postWeb3(o, r, brief, btn) {
    ...
    fetch("https://api.web3forms.com/submit", {
      ...
      body: JSON.stringify({ access_key: WEB3_KEY, subject: "Brief z wyceny — Klarmint", from_name: "Klarmint wycena", email: o.email, message: brief, _template: "table" })
